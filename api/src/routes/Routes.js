...
router.get('/Battle/:id_battle', BattleController.retrieveBattlebyID);
router.put('/Battle/:id_battle', auth, BattleController.updateBattlebyID);
router.delete('/Battle/:id_battle', auth, BattleController.deleteBattle);
